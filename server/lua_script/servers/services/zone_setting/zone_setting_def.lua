...
Zone_Setting_Const.db_path_zone_allow_work_servers_format = "/%s/zone_setting/allow_work_servers" -- /$zone_name/zone_setting/allow_work_servers
Zone_Setting_Const.db_path_zone_role_min_nums_format = "/%s/zone_setting/role_min_nums" -- /$zone_name/zone_setting/role_min_nums
Zone_Setting_Const.db_path_is_setting_ready_format = "/%s/zone_setting/is_ready" -- /$zone_name/zone_setting/is_ready

Zone_Setting_Event = {}
Zone_Setting_Event.zone_setting_allow_join_servers_diff = "Zone_Setting_Event.zone_setting_allow_join_servers_diff"
Zone_Setting_Event.zone_setting_allow_work_servers_diff = "Zone_Setting_Event.zone_setting_allow_work_servers_diff"
Zone_Setting_Event.zone_setting_role_min_nums_diff = "Zone_Setting_Event.zone_setting_role_min_nums_diff"
Zone_Setting_Event.zone_setting_is_ready = "Zone_Setting_Event.zone_setting_is_ready"
