...
Service_Name.client_net = "client_net"
Service_Name.join_cluster = "join_cluster"
Service_Name.world_server_monitor = "world_server_monitor"
Service_Name.work_world_shadow = "work_world_shadow"
Service_Name.http_net = "http_net"