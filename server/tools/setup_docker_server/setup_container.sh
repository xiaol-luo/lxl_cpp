...
# mkdir -p /shared/docker/data_dir
# git clone https://github.com/xiaol-luo/lxl_cpp.git  /shared/docker/data_dir/lxl_cpp
# cd /shared/docker/data_dir/lxl_cpp
# git checkout -b service_discovery  remotes/origin/service_discovery
...
docker exec test_lxl sh /shared/docker/data_dir/lxl_cpp/server/tools/setup_docker_server/setup_server.sh
