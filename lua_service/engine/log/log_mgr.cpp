...
static LoggerConfig S_LOG_CONFIGS[/*ELogger_Max*/] = {
	LoggerConfig(ELoggerType_Rotating, "debug", "debug.log", DEFAULT_RORATING_MAX_SIZE, DEFAULT_RORATING_MAX_FILE, DEFAULT_DAILY_HOUR, DEFAULT_DAILY_MIN),
	LoggerConfig(ELoggerType_Rotating, "info", "info.log", DEFAULT_RORATING_MAX_SIZE, DEFAULT_RORATING_MAX_FILE, DEFAULT_DAILY_HOUR, DEFAULT_DAILY_MIN),
	LoggerConfig(ELoggerType_Daily, "warn", "warn.log", DEFAULT_RORATING_MAX_SIZE, DEFAULT_RORATING_MAX_FILE, DEFAULT_DAILY_HOUR, DEFAULT_DAILY_MIN),
