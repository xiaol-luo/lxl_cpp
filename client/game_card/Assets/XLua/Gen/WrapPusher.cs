    ...
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderUnityEngineVector2
        {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterPushAndGetAndUpdate<Utopia.LogLevel>(translator.PushUtopiaLogLevel, translator.Get, translator.UpdateUtopiaLogLevel);
        ...
        int UtopiaLogLevel_TypeID = -1;
		int UtopiaLogLevel_EnumRef = -1;
