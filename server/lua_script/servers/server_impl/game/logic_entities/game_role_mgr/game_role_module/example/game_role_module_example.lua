...
---@class GameRoleModuleExample:GameRoleModule
GameRoleModuleExample = GameRoleModuleExample or class("RoleBaseInfo", GameRoleModule)

function GameRoleModuleExample:ctor(role)
    GameRoleModuleExample.super.ctor(self, role, Game_Role_Module_Name.example)
    self._data_struct_version = nil
    self._example_name = nil
end

function GameRoleModuleExample:_on_init_from_db(db_ret)
...
function GameRoleModuleExample:_on_pack_for_db(out_ret)
    local db_info = {}
...
function GameRoleModuleExample:set_example_name(example_name)
...
function GameRoleModuleExample:get_example_name()
